...
if("TRUE" STREQUAL "TRUE")
  set(qtros_SOURCE_PREFIX /home/lqdung/catkin_ws/src/qtros)
  set(qtros_DEVEL_PREFIX /home/lqdung/catkin_ws/src/build-qtros-Desktop_Qt_5_7_0_GCC_64bit-Default/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'qtros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Le Quang Dung <lqdung95ntp@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'qtros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lqdung/catkin_ws/src/qtros/${idir}'.  Ask the maintainer 'Le Quang Dung <lqdung95ntp@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lqdung/catkin_ws/src/build-qtros-Desktop_Qt_5_7_0_GCC_64bit-Default/devel/lib;/home/lqdung/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
